...
int run_IRKE(int argc, char* argv[]) {
    ...
    irke.populate_sorted_kmers_list();  // doing this before pruning in case it helps with memory organization
    ...
    else if (search_CDS_flag) { // define the 'oracle' transcript set
